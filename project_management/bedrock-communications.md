...
Open
- **2026-08-14** - **4-Bucket Confusion Matrix Client Deliverable Framing**: Finalized strategy to report Milestone 2 performance to Bedrock using 4-bucket confusion matrices (raw counts and percentages: UXO-like, Non-UXO-like, Background) and side-by-side real vs. synthetic target visual comparisons, presenting test-time scaling as an optional configuration (source: Iris Sync - 2026_08_14).
- **2026-08-12** - **Real vs. Synthetic Sonar Image Classification Game**: Proposed developing a lightweight interactive application for Bridget/Bedrock stakeholders challenging users to distinguish real side-scan sonar contacts from procedurally generated synthetic targets to demonstrate synthetic data pipeline realism (source: Iris Sync - 2026_08_12).
...
Resolved
- **2026-07-01** - **Mag Data Sync with Francisco Bolivar**: Clarified the Mosaic cloud platform pipeline and the OBF file schema. We discussed the offline nature of coefficient compensation, the 5 nT and 10 nT detection thresholds, and using upward continuation for altitude scaling. Bedrock also explained their inverse distance weighting grid interpolation for magnetic map generation (source: Bedrock__Crescer_ Mag Discussion - 2026_07_01).
- **2026-06-23** - **SOW 2 Initial Alignment**: Alignment meeting on SOW 2 scope, setting a target completion date of July 1, 2026, for Milestones 1 and 2 client demonstration, and defining responsibilities for SSS and magnetometer data co-registration (source: Bedrock SOW 2.md and source: Bedrock Discussion Cont - 2026_06_23).
...
**Sources**: raw/Internal Bedrock x CrescerAI Initial SOW.md; raw/Bedrock SOW 2.md; raw/meeting_transcripts/Bedrock Discussion Cont - 2026_06_23; raw/meeting_transcripts/Bedrock__Crescer_ Mag Discussion - 2026_07_01; raw/meeting_transcripts/Bedrock connect - 2026_07_17; raw/meeting_transcripts/Iris Sync - 2026_08_03 12_28 EDT - Notes by Gemini.md; raw/meeting_transcripts/Iris Sync - 2026_08_10 12_27 EDT - Notes by Gemini.md; raw/meeting_transcripts/Iris Sync - 2026_08_12 12_27 EDT - Notes by Gemini.md; raw/meeting_transcripts/Iris Sync - 2026_08_14 12_30 EDT - Notes by Gemini.md
